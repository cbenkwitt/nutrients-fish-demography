...
##########CHANGE RAT-INFESTED TO TRIANGLES TO MATCH OTHER PLOTS###########
...
ggsave(filename = "nitrogen_combined_plots_3b.pdf", 
       plot = aligned_n_plot,
       width = 20, 
       height = 13.3,
       units = "cm",
...
####OLD:
###combine plots
box_aligned<-plot_grid(Nperc_box, N15_box, ncol = 1, align = "v")
box_aligned

post_aligned<-plot_grid(Nperc_post_plot, N15_post_plot, ncol = 1, align = "v")
post_aligned

nitrogen_combined_plots<-
ggdraw() +
  draw_plot(box_aligned, x = 0, y = 0, width = .5, height = 1) +
  draw_plot(post_aligned, x = .5, y = 0, width = .5, height = 1) +
  draw_plot_label(label = c("a", "c", "b", "d"), size = 12,
                  x = c(0.12, 0.12, 0.51, .51), y = c(.99, .49, .99, 0.49))

nitrogen_combined_plots

#nitrogen_combined_plots2<-plot_grid(Nperc_box, Nperc_post_plot, N15_box,N15_post_plot,
#                    ncol = 2, align = c("v", "h"))
#nitrogen_combined_plots2


#export pdf:
ggsave(filename = "nitrogen_combined_plots_June2.pdf", 
       plot = nitrogen_combined_plots2,
       width = 17, 
       height = 12,
       units = "cm",
       dpi = 300,
...
##export eps, preserve fonts and transparency (but then illustrator doesn't recognise as fonts: 
ggsave(filename = "nitrogen_combined_plots_May22.eps", 
       plot = nitrogen_combined_plots,
       width = 17, 
       height = 12,
       units = "cm",
       dpi = 300,
       family = "sans", device=cairo_ps, fallback_resolution = 600)
